...
export default async function ProductsPage({ searchParams }) {
  ...
  return <main><Header /><div className="pt-[78px]"><Catalog activeCategory={activeCategory} visibleFilters={visibleFilters} visibleProducts={visibleProducts} /></div><Footer /><WhatsAppButton /></main>;
}
