...
const statuses = [['novo','Novo'],['confirmado','Confirmado'],['em_preparo','Em preparo'],['pronto_para_envio','Pronto para envio'],['enviado','Enviado (frete manual)'],['saiu_para_entrega','Saiu para entrega (legado)'],['cancelado','Cancelado']];
